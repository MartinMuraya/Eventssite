...
//     setStatus("");
//     try {
//       await axios.post("https://eventssite-1.onrender.com/api/contact", formData);
  ...
  return (
    <div className="min-h-screen bg-gray-200 flex flex-col items-center justify-center px-4 py-16">
      ...
      <div className="mt-12 w-full max-w-3xl bg-white p-8 rounded-lg shadow-lg">
        ...
        {status && <p className={`text-center mb-4 ${status.startsWith("✅") ? "text-green-600" : "text-red-600"}`}>{status}</p>}
